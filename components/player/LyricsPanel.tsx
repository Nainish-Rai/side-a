            ...
            {lyrics.parsed.map((line, index) => {
              ...
              return (
                <p
                  ...
                  className={cn(
                    "lyrics-line synced-line text-lg md:text-xl font-medium text-center transition-all duration-150",
                    isActive && "active text-white scale-110 blur-none font-bold",
                    isUpcoming && "upcoming text-white/60 blur-none",
                    isPast && "past text-white/30 blur-[1px]",
                    !isActive && !isUpcoming && !isPast && "text-white/30 blur-[1.5px]"
                  )}
                  data-index={index}
                  data-time={line.time}
