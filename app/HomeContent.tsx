          ...
          <div className="max-w-6xl mx-auto px-6 pt-4">
            <div className="border border-foreground/10">
              <div className="grid grid-cols-[220px_auto_minmax(300px,1fr)_auto] items-center">
                <div className="px-5 h-full items-center flex border-r border-foreground/10">
                ...
                <div className="px-5 h-full items-center flex border-r border-foreground/10">
                  <div className="flex items-center gap-6">
                    <span className="relative inline-flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-foreground">
                ...
                <div className="min-w-0 px-5 border-r border-foreground/10">
                  <SearchBar
                    onSearch={handleSearchWithTracking}
                    isLoading={isLoading}
                  />
